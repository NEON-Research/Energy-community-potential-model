...
plotECs <- create_plot("Energy communities")
plotProjects <- create_plot("Projects")
plotMembers  <- create_plot("Members")
plotInstalledCapacity  <- create_plot("Installed capacity")
